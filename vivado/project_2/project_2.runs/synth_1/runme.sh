...
HD_PWD='C:/Verilog/vivado/project_2/project_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log tb_calculator.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source tb_calculator.tcl
